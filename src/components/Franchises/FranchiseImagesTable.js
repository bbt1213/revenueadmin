...
const FranchiseImagesTable = (props) => {
    ...
    },
    {
      ...
      content: (image) => (
        <textarea
          ...
          id={`remarks-${image.ptFranchiseDocumentVerificationId}`}
    ...
    },
    {
      ...
      content: (image) => (
        <select
          ...
          id={image.ptFranchiseDocumentVerificationId}
        >
  ...
  return (
    ...
    <Table
      datas={images}
      columns={columns}
      keyName="ptFranchiseDocumentVerificationId"
    />
  );
};
